...
<meta charset="utf-8">
<title>formulario para Reserva</title>
</head>
<body>
	<div class="corpoPagina">
		...
		<div class="container">
			<form action="./reserva-create" class="" method="post">
				<fieldset>
				...
				<fieldset>
					...
					<div class="form-group my-3">
						<label for="iDataReserva" class="form-label">Data da Reserva:</label> <input
							type="date" id="iDataReserva" name="nDataReserva" class="form-control" />
					</div>

					<div class="form-group my-3">
						<label for="iCPFUsuario" class="form-label">CPF:</label> <input
							type="text" id="iCPFUsuario" name="nCpf" class="form-control" placeholder="É necessario ter cadastro de usuario, para realizar compras!"/>
					</div>
					...
					<div class="form-group my-3">
						...
						<option value="${hospedagem.id }">${hospedagem.nome} / ${hospedagem.cidade }</option>
						</c:forEach>
						</select>
					</div>
					<div class="form-group my-3">
						<label for="iQtdDias" class="form-label">Quantidade de dias à reservar:</label> <input
							type="text" id="iQtdDias" name="nQtdDias" class="form-control" placeholder="1, 2, 3..."/>
					</div>
