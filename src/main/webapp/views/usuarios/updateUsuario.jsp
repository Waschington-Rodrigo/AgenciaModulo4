...
<body>
	<div class="corpoPagina">
		...
		<div class="container">
			<form action="./usuario-update" class="" method="post">
				<fieldset>
					<legend>Dados Pessoais</legend>
					<div class="form-group my-3">
						<label for="iId" class="form-label">Id:</label> <input
							type="text" id="iId" name="nId" class="form-control"
					...
					<div class="form-group my-3">
						<label for="iEmail" class="form-label">Email:</label> <input
							type="text" id="iEmail" name="nEmail" class="form-control" value="${usuario.email}"/>
					</div>

					<div class="form-group my-3">
						<label for="iTelefone" class="form-label">Telefone:</label> <input
							type="text" id="iTelefone" name="nTelefone" class="form-control" value="${usuario.telefone}" />
					</div>
				</fieldset>
				...
				<fieldset>
					...
					<div class="form-group my-3">
						<label for="iEndereco" class="form-label">Endereço:</label> <input
							type="text" id="iEndereco" name="nEndereco" class="form-control" value="${usuario.endereco}" />
					</div>

					<div class="form-group my-3">
						<label for="iEstado" class="form-label">Estado:</label> <input
							type="text" id="iEstado" name="nEstado" class="form-control" value="${usuario.estado}" />
					</div>

					<div class="form-group my-3">
						<label for="iCidade" class="form-label">Cidade:</label> <input
							type="text" id="iCidade" name="nCidade" class="form-control" value="${usuario.cidade}" />
					</div>
				</fieldset>
