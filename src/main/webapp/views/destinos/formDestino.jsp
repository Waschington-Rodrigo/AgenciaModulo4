...
<meta charset="utf-8">
<title>formulario para Destinos</title>
</head>
<body>
	<div class="corpoPagina">
		...
		<div class="container">
			<form action="../../destino-create" class="" method="post">
				<fieldset>
					...
					<div class="form-group my-3">
						<label for="iLocalDestino" class="form-label">Local de
							...
							name="nLocalDestino" class="form-control" />
					</div>
					<div class="form-group my-3">
						<label for="iValor" class="form-label">Valor:</label> <input
							type="text" id="iValor" name="nValor" class="form-control" />
					</div>
				</fieldset>
				<fieldset>
