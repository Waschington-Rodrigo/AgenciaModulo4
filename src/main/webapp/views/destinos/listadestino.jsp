...
<body>
	<div class="corpoPagina">
		...
		<div class="container-fluid opacity">
			...
			<a href="./views/destinos/formDestino.jsp"
				class="btn btn-primary my-1"><span class="fw-bold">+</span>Destino</a>
						...
						<tr class="text-center">
							...
							<td>
								<div class=text-center>
									<a href="./destino-update?id=${destino.id}"
										class="btn btn-success">Editar</a> <a
										href="./destino-delete?id=${destino.id}"
										onclick="return confirm('Deseja Excluir o destino ${destino.localDestino} de ${destino.cidade }?')"
