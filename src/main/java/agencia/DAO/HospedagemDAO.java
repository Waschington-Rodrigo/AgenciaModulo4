...
public class HospedagemDAO {
	public void save(Hospedagem hospedagem) {
		...
		String sql = "INSERT INTO hospedagem(cidade,estado,tipo,valorDiaria,endereco,telefone,nome)"
				+ " VALUES(?,?,?,?,?,?,?)";
	...
	public void update(Hospedagem hospedagem) {
		String sql = "UPDATE hospedagem SET cidade = ?, estado = ?, tipo = ?, valorDiaria = ?, endereco = ?, telefone = ?, nome = ?"
				+ "WHERE id = ?";
