...
public class UsuarioDAO {
	public void save(Usuario usuario) {
		...
		String sql = "INSERT INTO usuario(telefone,endereco,estado,cidade,email,nome,cpf,dataNascimento)"
				+ " VALUES(?,?,?,?,?,?,?,?)";
	...
	public void update(Usuario usuario) {
		String sql = "UPDATE usuario SET telefone = ?, endereco = ?, estado = ?, cidade = ?, email = ?, nome = ?, cpf = ?, dataNascimento = ? "
				+ "WHERE id = ?";
